...
import machinebanner from '../../../public/assets/images/machines.png';
...
const MachinesBanner: FC = (): ReactElement => {
    return(
    <div className='pb-6 pt-32 md:pt-40 lg:pb-10'>
        ...
        <SmallStrokeStarIcn className='animate-spin-slow absolute top-0 right-5 lg:left-4'/>
            <div className='relative pb-8 md:pb-10 lg:self-end lg:w-2/5'>
                <h1 className='text-3xl font-bold text-black font-Montserrat tracking-bigger-tighter-letter-spacing pr-14 md:pr-0 md:text-5xl lg:text-6xl 2xl:text-8xl'>Machines</h1>
                <p className='text-lg font-Nunito text-theme-grey mt-2 md:text-2xl'>Mauris neque nisi, faucibus non elementum in, convallis et eros. Sed pretium sem libero, vel pellentesque purus ultrices ut. In quis leo id massa pulvinar.</p>
            ...
            <div className='relative mt-7 z-10 lg:mt-0 lg:w-3/5 lg:pl-16'>
                ...
                <Image src={machinebanner} width="950" height="649" alt="Printing" className='relative rounded-2xl'/>
            </div>
